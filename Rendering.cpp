...
void Rendering::render_unit(HINSTANCE p_hinst, HDC p_dc, int p_rsc, POINT p_pos, RECT p_area) {
	HDC h_imgdc;
	...
	BitBlt(p_dc, p_pos.x + p_area.left, p_pos.y + p_area.top, p_pos.x + p_area.right, p_pos.y + p_area.bottom, h_imgdc, 0, 0, SRCCOPY);
